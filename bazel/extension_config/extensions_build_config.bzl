...
# The content of this dictionary is copied from @envoy//source/extensions:extensions_build_config.bzl
# Should this list be updated every time maistra/scripts/update-envoy-sha.sh is executed?
ENVOY_EXTENSIONS = {
    #
    # Access loggers
    #
    ...
    # CacheFilter plugins
    #
    "envoy.cache.simple_http_cache":                    "//source/extensions/http/cache/simple_http_cache:config",
...
#   FIXME: https://issues.redhat.com/browse/OSSM-1208
